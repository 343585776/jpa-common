...
/**
 * 分布式唯一ID生成器(对比UUID方式,该方式提供了趋势有序性,如果需求要求必须有序可以采用)
 * <p>
...
public class SnowflakeIdHelper {
    ...
    private static class IdGenHolder {
        private static final SnowflakeIdHelper INSTANCE = new SnowflakeIdHelper();
    }

    public static SnowflakeIdHelper get() {
